...
This software and associated documentation (the "Software") are provided for personal, academic, educational, research, and evaluation use.
...
* Represent altered versions as the official AICS specification
